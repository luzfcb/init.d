...
#
# About:
#   Install RustDesk during container startup.
#
# Guide:
#   Add this script to your startup scripts by running:
#       $ ln -sf "./scripts/install-rustdesk.sh" "${USER_HOME:?}/init.d/install-rustdesk.sh"
#
###
...
package_description="RustDesk is a full-featured open source remote control alternative for self-hosting and security with minimal configuration."
package_icon_url="https://avatars.githubusercontent.com/u/71636191?v=4"
